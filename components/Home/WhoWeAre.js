...
export default function WhoWeAre() {
  return (
    <div className="w-full h-max bg-[#E5E5E5]">
      <div class="w-4/5 bg-black py-8 lg:py-14 fade-in-down flex flex-col items-center px-4 lg:px-16 mx-auto rounded-3xl">
        <h2 className="text-white text-xl lg:text-4xl lg:w-1/2 leading-snug text-center poppins-regular">
          Out of thousands of options—here's why our clients trust us.
        </h2>
        <p className="text-white mt-4 text-sm text-center lg:text-base poppins-light">
